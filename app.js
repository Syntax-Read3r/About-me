...
function questionFour() {
	...
	while (
		answerFour.toLowerCase() !== "yes" &&
		answerFour.toLowerCase() !== "no"
	) {
...
function questionFive() {
	...
	while (
		answerFive.toLowerCase() !== "yes" &&
		answerFive.toLowerCase() !== "no"
	) {
...
function questionSix() {
	...
	alert(
		`Well done, so far you have gotten ${res} out of 5. Let's change the pace a little bit.`
	);
	...
	if (!chcker) {
		alert(
			"The year I broke my leg was 2008. This happened while I was playing basketball in High School."
		);
	}
}
...
alert(
	"This is the final question. This question will have multiple correct answers."
);
}
;
